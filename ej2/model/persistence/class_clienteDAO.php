...
class clienteDAO extends db{
	...
	public function inserir($cliente) {
	    ...
	    $query="insert into cliente (dni, nombre, apellidos,fechaN) values ('".$cliente->getDni()."',
			'".$cliente->getNombre()."', '".$cliente->getApellidos()."','".$cliente->getFecha()."');";
	...
	public function modificar($cliente){
		...
		set dni='".$cliente->getDni()."',nombre='".$cliente->getNombre()."',apellidos='".$cliente->getApellidos()."',fechaN='".$cliente->getFecha().
